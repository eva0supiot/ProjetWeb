...
if(!isset($_GET["id"]) || empty($_GET["id"])){
	// pas d'id
	header("Location: biens_appart.php");
	exit;
}
...
$sql ="SELECT * FROM `immo_appart` WHERE `id` = :id";
	...
	<div class=maison>
		...
		<div class="slide-container">
      		<div class="custom-slider fade">
        		<img class="slide-img" src="maisons_du_projet/appart<?php echo $maison["id"] ?>_1.png">
      		</div>
      		<div class="custom-slider fade">
        		<img class="slide-img" src="maisons_du_projet/appart<?php echo $maison["id"] ?>_2.png">
      		</div>
      		<div class="custom-slider fade">
        		<img class="slide-img" src="maisons_du_projet/appart<?php echo $maison["id"] ?>_3.png">
      		</div>
      		<div class="custom-slider fade">
      			<img class="slide-img" src="maisons_du_projet/appart<?php echo $maison["id"] ?>_4.png">
      		</div>
      		<div class="custom-slider fade">
      			<img class="slide-img" src="maisons_du_projet/appart<?php echo $maison["id"] ?>_5.png">
      		</div>
      		<div class="custom-slider fade">
      			<img class="slide-img" src="maisons_du_projet/appart<?php echo $maison["id"] ?>_6.png">
      		</div>
      		<div class="custom-slider fade">
      			<img class="slide-img" src="maisons_du_projet/appart<?php echo $maison["id"] ?>_7.png">
      		</div>
		...
		<div class="bouton_test">
		<?php if ($maison["pdf"]==1) { ?>
			<h4><a href="maisons_du_projet/appart<?php echo $maison["id"] ?>.pdf">Voir le PDF</a></h4>
		<?php } ?>
		</div>
