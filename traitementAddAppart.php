...
<?php
	...
	*/
	...
	if($db_found):	// si on trouve la BDD 
		...
		$sql="";
		$sql="INSERT INTO `immo_appart` (`nom`, `adresse`, `prix`, `type`, `dimension`, `chambre`, `salle_de_bain`, `toilette`, `cuisine`, `salon`, `a_propos`, `caracteristique_principale`, `video`, `pdf`) 

		VALUES('$nom', '$adresse', $prix, 'Appartement', $dimension, $chambre, $salle_de_bain, $toilette, $cuisine, $salon, '$a_propos', '$caracteristique_principale',0,0)";

		$result = mysqli_query($db_handle, $sql);

		?>
			<div class="centre">
				<h2>L'appartement' a été ajouté</h2>
			</div>
