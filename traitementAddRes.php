...
<?php
	...
	*/
	...
	if($db_found):	// si on trouve la BDD 
		...
		$sql="";
		$sql="INSERT INTO `immo_res` (`nom`, `adresse`, `prix`, `type`, `surface`, `dimension`, `chambre`, `salle_de_bain`, `toilette`, `cuisine`, `salon`, `a_propos`, `caracteristique_principale`, `video`, `pdf`) 
		VALUES('$nom', '$adresse', $prix, 'Résidence', $surface, $dimension, $chambre, $salle_de_bain, $toilette, $cuisine, $salon, '$a_propos', '$caracteristique_principale',0,0)";

		$result = mysqli_query($db_handle, $sql);

		?>
			<div class="centre">
				<h2>La résidence a été ajouté</h2>
			</div>
